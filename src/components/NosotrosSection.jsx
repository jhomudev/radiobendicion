      ...
      <div ref={nos} className="relative bg-white font-advent">
         <div className="relative container mx-auto px-[5%] h-auto py-[5%]">
            ...
            <div className="relative h-[40rem] flex flex-col md:flex-row gap-5 items-center justify-center box-border p-1 lg:p-10 font-rale">
               ...
               />
               <div className="bg-c_main-normal drop-shadow-2xl text-white w-[90%] mb-0 md:mb-48 h-min max-w-xl px-7 py-5 rounded-xl">
                  ...
                  <p className="text-sm sm:text-base font-advent">
                     ...
                     sociedades con una perspectiva bíblica y cristo céntrica. y
                     lleguen a ser salvos.
                  </p>
               </div>
               <div className="bg-c_red drop-shadow-2xl text-white w-[90%] mt-0 md:mt-60 h-min max-w-xl px-7 py-5 rounded-xl">
                  ...
                  <p className="text-sm sm:text-base font-advent">
                     ...
                     educativa, cultural Cristo céntrica y llegue a ser un
