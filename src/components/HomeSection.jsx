...
import imgSamugari from "../assets/imgSamugari.jpeg";
      ...
      <div className="relative container min-h-[calc(100vh-5rem)] mx-auto px-[5%] grid grid-cols-1 lg:grid-cols-2 justify-center lg:items-center">
        ...
        <div className="relative z-1 lg:col-end-2 flex flex-col items-center justify-center text-white">
          <strong
            ...
            className="flex flex-wrap w-full mt-14 lg:-mt-20 font-crimson font-extrabold italic text-5xl tracking-wider"
          >
            RADIO BENDICIÓN
            <br />
            90.5 FM
          ...
          <p
            ...
            data-aos-duration="1000"
            data-aos-easing="ease"
            className="text-md font-advent mt-4"
          >
            La radio bendicion.com 90.5 FM. Es una bendición para creyentes en
            Cristo y el público en general de habla quechua y hispana. Es una
            radio digital que transmite desde Perú para todo el mundo.
          </p>
          <i
            data-aos="fade-up"
            data-aos-duration="1000"
          ...
          >
            "Aclamad con júbilo al SEÑOR, toda la tierra; prorrumpid y cantad
            con gozo, cantad alabanzas." Salmos 98:4
          </i>
        </div>
